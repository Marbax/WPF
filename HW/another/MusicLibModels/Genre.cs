...
{
    public class Genre : IValidatableObject, INotifyPropertyChanged
    {
        private int _id;
        public int Id
        {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (Id == default)
                errors.Add(new ValidationResult("Genre identifier is default."));
            if (string.IsNullOrWhiteSpace(this.Name) || Name.Length < 3 || Name.Length > 50)
                errors.Add(new ValidationResult("Wrong Genre Name."));
        ...
        {
            return Name.Equals((obj as Genre).Name);
        }
